...
<template>
  <div class="bg-surface-sunken px-3 py-2 flex items-center justify-between relative rounded-t-xl2 overflow-hidden">
    ...
    <div class="relative z-10 flex items-center">
      ...
      >
        <span class="mr-0 animate-pulse" style="position: relative; left: -4px;">●</span>
        <span class="hidden sm:inline font-bold">SOON</span>
        <span class="sm:hidden" style="position: relative; left: -4px;">●</span>
      </div>
      <div
        v-else-if="raceStatus === 'live'"
        ...
        style="margin-right: 0;"
      >
        <span class="mr-1 animate-ping" style="position: relative; left: -4px">●</span>
